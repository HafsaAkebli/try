...
# Define parameters
tilesize = 250  # Size of the tile (500x500 pixels)
tileradius = tilesize // 2  # Half the size of the tile (250 pixels)
step = 100  # Step for the sliding window
...
patch_folders = ["/home/akebli/test5/Patches1/Subset2/morepatches"]
...
for patch_folder in patch_folders:
    ...
    output_features_file = f"/home/akebli/test5/features_{subset_name}_250_0.7.npz"
